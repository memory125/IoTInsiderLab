...
namespace Sensors.OneWire
{
	public sealed partial class MainPage : BindablePage
    {
        ...
        {
            var stringTxt = string.Format("Humidity:{0:0.00}% RH; Temperature:{1:0.00}°C", this.Humidity, this.Temperature);
            var messageString = Newtonsoft.Json.JsonConvert.SerializeObject(stringTxt);
